...
export default function RescuedAnimal() {
    ...
    const handleForm = (e: any) => {
        ...
        const data = {
            ...
            type: String(form.type.defaultValue),
            date: String(form.date.value),
    ...
    return (
        <div>
            <form onSubmit={handleForm} className='grid gap-1 mx-20 pt-5'>
                ...
                <input type="text" name='type' className='border p-1' placeholder='Type' defaultValue={'Under observation'} disabled />
